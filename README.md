...
Airline Tycoon V1.0.3 is the map aircraft icon, fleet detail, and schedule flow fixes release. Some data, economy calculations, route demand, and scheduling systems remain simplified for gameplay balance.
